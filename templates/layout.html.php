...
<body id="page-top" class="index">
    <header class="tete">
        ...
        <a href="index.php?controller=card&task=index"><img src="./upload/Logo.png" alt="" srcset=""></a>
        ...
        <ul>
            ...
            <li> <span><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-house" viewBox="0 0 16 16">
                    ...
                    </svg></span> <a href="index.php?controller=card&task=index"> Accueil</a></li>
            ...
            <?php if (isset($_SESSION['id'])) { ?>
                ...
                <li><span><svg xmlns=" http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-circle" viewBox="0 0 16 16">
                            <path d="M11 6a3 3 0 1 1-6 0 3 3 0 0 1 6 0z" />
                            <path fill-rule="evenodd" d="M0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8zm8-7a7 7 0 0 0-5.468 11.37C3.242 11.226 4.805 10 8 10s4.757 1.225 5.468 2.37A7 7 0 0 0 8 1z" />
                        </svg></span> <a href="index.php?controller=game&task=myResult">Mes résultats</a> </li>
                <!-- ======================================================================================== -->
                <!-- =============================  DECONNEXION ================================================= -->
                <!-- ======================================================================================== -->
    ...
    <footer>
        <p>©<?= date("Y") ?> par Sébastien Mouret lien git hub :
            <a href="https://github.com/sebastienwolf/Memory-Pokemon"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-github" viewBox="0 0 16 16">
